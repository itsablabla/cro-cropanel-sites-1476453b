# Missing trust signals above the fold — dev spec
Site: example.com · Priority 2 · High · Effort: Medium (2-5 days)

## Problem
The homepage shows no sign of returns policy, guarantee, reviews, or security badge, so first-time visitors have nothing to offset purchase risk.
